...
export interface InitOutput {
    ...
    readonly deriveMasterKeysHandleBytes: (a: any) => [number, number, number, number];
    ...
    readonly exportFinalizedPreflightedTransactionInternal: (a: number, b: number) => [number, number, number, number];
    readonly exportPreflightedTransactionInternal: (a: number, b: number) => [number, number, number, number];
    readonly exportSubmittedPreflightedTransactionInternal: (a: number, b: number) => [number, number, number, number];
    ...
    readonly getBrowserSupportStatusJson: () => [number, number, number, number];
