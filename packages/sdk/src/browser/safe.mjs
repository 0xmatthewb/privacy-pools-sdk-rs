...
export function clearBrowserCircuitSessionCache() {
  return unsafe.clearBrowserCircuitSessionCache();
}

export function supportsExperimentalThreadedBrowserProving() {
  return unsafe.supportsExperimentalThreadedBrowserProving();
}

export function initializeExperimentalThreadedBrowserProving(options) {
  return unsafe.initializeExperimentalThreadedBrowserProving(options);
}
...
export function createWorkerClient(worker) {
  return new PrivacyPoolsSdkClient(unsafe.createWorkerClient(worker));
}
