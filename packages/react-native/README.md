...
- long-running proof/execution work can be started as native Rust-backed jobs and observed with explicit status polling, typed result retrieval, callback-style progress helpers, and best-effort cancellation
